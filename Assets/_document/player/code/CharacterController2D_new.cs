...
public class CharacterController2D_new : MonoBehaviour
{
	...
	public void ApplyDamage(float damage, Vector3 position) 
	{
		if (!invincible)
		{
			...
			else
			{
				...
				StartCoroutine(MakeInvincible(1.2f));
			}
		}
	}
	...
	IEnumerator WaitToDead()
	{
		...
		animator.SetBool("startDead", true);

		canMove = false;
		invincible = true;
		GetComponent<Attack_new>().enabled = false;
